            ...
            >
              <div
                className={`w-11 h-11 shrink-0 rounded-full flex items-center justify-center text-xl ${
                  a.unlocked ? "bg-amber-500/15" : "bg-white/5 grayscale opacity-50"
                }`}
              >
                {a.unlocked ? a.icon : <Lock className="w-4 h-4 text-gray-600" />}
              </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className={`text-sm font-medium ${a.unlocked ? "text-white" : "text-gray-300"}`}>
                  {a.title}
                </p>
