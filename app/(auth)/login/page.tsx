    ...
    <div className="w-full max-w-sm">
      <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
        ...
        {urlError === "invalid_token" && (
          <p className="text-xs text-red-400 mb-4">Lien de confirmation invalide.</p>
        )}
        {urlError === "expired_token" && (
          <p className="text-xs text-red-400 mb-4">
            Ce lien de confirmation a expiré, connecte-toi pour en redemander un.
          </p>
        )}
          ...
          <div className="flex flex-col gap-4">
            ...
            {needsVerification && (
              <div className="text-xs text-gray-500">
                {resendState === "sent" ? (
                  <span className="text-emerald-400">Email de confirmation renvoyé.</span>
                ) : (
                  <button
