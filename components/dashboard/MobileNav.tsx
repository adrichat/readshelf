            ...
            {open && (
              <motion.div key="drawer" className="fixed inset-0 z-50 md:hidden">
                ...
                <motion.div
                  ...
                  className="absolute inset-y-0 left-0 w-72 max-w-[85vw] bg-[#0d0d12] border-r border-white/10 flex flex-col p-4 overflow-y-auto"
                >
                  ...
                  <div className="border-t border-white/5 pt-4">{signOutSlot}</div>
                </motion.div>
              </motion.div>
            )}
          </AnimatePresence>,
